 ...
 */
package examples.ex.bulletstimer;
 ...
 */
public class BulletsUsingTimer extends Applet {
    ...
    public void start() {
        screen.setGraphics();
        for (int i = 0; i < 100; i++)
            animationTimer.schedule(new Bullet(new Color((int) (random()
                    * Integer.decode("0xFFFFFF"))), screen), 0, 30);
    }
}
